	...
	namespace World
	{
		namespace Network
		{
			...
			public:
				...
				void	ClientUpdate(ZoneServer* zoneserver, char* name, int32 accountid, char* accountname, int8 admin, int32 zone, int8 level, int8 class_, int8 race, int8 anon, bool tellsoff, int32 in_guilddbid, int32 in_guildeqid, bool LFG);
				void	ClientRemove(char* name, int32 zone);
