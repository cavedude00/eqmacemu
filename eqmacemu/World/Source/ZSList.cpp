...
namespace EQC
{
	namespace World
	{
		namespace Network
		{
			...
			void ZSList::ClientUpdate(ZoneServer* zoneserver, char* name, int32 accountid, char* accountname, int8 admin, int32 zone, int8 level, int8 class_, int8 race, int8 anon, bool tellsoff, int32 guilddbid, int32 guildeqid, bool LFG)
			{
				LinkedListIterator<ClientListEntry*> iterator(clientlist);
